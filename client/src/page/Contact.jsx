        ...
        <div className="container px-6 py-12 mx-auto">
          ...
          <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <p className="mt-2 text-gray-500 dark:text-gray-400">I am here to help.</p>
              <p className="mt-2 text-blue-500 dark:text-blue-400">rahmantoymur2@gmail.com</p>
            </div>
            ...
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <p className="mt-2 text-gray-500 dark:text-gray-400">mirpur</p>
              <p className="mt-2 text-blue-500 dark:text-blue-400">Dhaka</p>
            </div>
